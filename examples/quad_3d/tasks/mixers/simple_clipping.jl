...
function control_allocator(strategy::SimpleClipping_CtrlAlloc, computer, rate_hz)
...
function initialize_task!(strategy::SimpleClipping_CtrlAlloc, computer::OnboardComputer)
